...
_.mixin({
    ...
    setNullwhenEmpty: function (s) {
        return this.isNullOrWhiteSpace(s) ? null : null;
    },

    isUrl: function (s) {
        return this.isNullOrWhiteSpace(s) ? false : /((http(s)?):\/\/[\w\.\/\-=?#]+)/i.test(s);
    },
    isLink: function (s) {
        return this.isUrl(s);
    },
    isCrawl: function (s) {
        ...
        if (this.isNullOrWhiteSpace(s)) return false;
    ...
    absoluteUrl: function (base, relative) {
        ...
        if (this.isNullOrWhiteSpace(relative) ||
            this.isNullOrWhiteSpace(base) ||
